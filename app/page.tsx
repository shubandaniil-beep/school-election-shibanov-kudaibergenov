...
const program = [
  ...
  { number: '02', icon: BriefcaseBusiness, title: 'Бизнес на практике', text: 'Бизнес-ярмарок станет больше, а новый бизнес-спринт поможет доводить идеи до проверки спроса.', accent: 'white' },
